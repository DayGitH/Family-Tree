class person():
    ...
    def __init__(self,id,nick_name,real_name,bday,gender,father_id,mother_id,
                 marriage,children,death_dte,notes):
        self.id = id
    ...
    def display(self):
        print('''ID: {}\nName: {}\nFull Name: {}\nBirthday: {}\nGender: {}\nFather ID: {}\nMother ID: {}\nMarriage: {}\nChildren: {}\nDeath: {}\nNotes: {}'''
              .format(self.id,self.nick_name,self.real_name,self.bday,
                      ...
                      self.children,self.death_dte,self.notes))
        
    def fetch(self):
        return self.id, self.nick_name, self.real_name, self.bday, self.gender, self.father_id, self.mother_id, self.marriage, self.children, self.death_dte, self.notes
  
if __name__ == '__main__':      
    bob = person('001','Bob','Robert','1982','M','002','003','004','','','This isn\'t really Robert')
    bob.display()
    
    [id, nick_name, real_name, bday, gender, father_id, mother_id, marriage, children, death_dte, notes] = bob.fetch()
